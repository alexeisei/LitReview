...
def create_critics(request):
    ...
    return render(request, "new_critic.html", {"form_crit": form_crit, "form_tik": form_tik, })
...
def edit_own_critics(request, review_id):
    ...
    return render(request, "edit_critic.html", {'edit_review_form': edit_review_form, 'ticket': ticket})
...
def edit_own_ticket(request, ticket_id):
    ...
    if edit_ticket_form.is_valid():
        ...
        return redirect('show-critics')
    return render(request, "edit_ticket.html", {'edit_ticket_form': edit_ticket_form})
